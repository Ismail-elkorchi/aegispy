...
| Deterministic replay                       | Valid for the current three-workload cross-host replay corpus                           | Stable replay hashes across a broader real-runtime compatibility corpus |
